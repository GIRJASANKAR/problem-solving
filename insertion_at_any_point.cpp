...
int main(){
     ...
     Node* node5=new Node(30); // 25,15,30,150;
       Node* node6=new Node(5);
             Node* node7=new Node(160);
     insertATPosition(head,2,node5);
      insertATPosition(head,2,node6);
 insertATPosition(head,5,node7);
  Node* node8=new Node(1);
 insertATPosition(head,1,node8);
